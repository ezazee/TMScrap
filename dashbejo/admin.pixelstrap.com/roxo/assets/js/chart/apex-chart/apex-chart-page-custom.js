...
var options = {
  ...
  colors: ['#6659ff', '#fa8070', '#63d5be', ' #feb858'],
  legend: {
    labels: {
      colors: 'var(--dark)',
      useSeriesColors: false,
...
var options7 = {
  ...
  colors: ['var(--secondary)', 'var(--success)', 'var(--primary)'],
  responsive: [
    {
      breakpoint: 576,
      options: {
...
var options8 = {
  ...
  colors: ['var(--primary)', 'var(--secondary)', 'var(--success)', 'var(--info)', 'var(--warning)'],
};
...
var options9 = {
  ...
  colors: ['var(--danger)', 'var(--warning)', 'var(--primary)', 'var(--success)', 'var(--info)'],
};
...
var options11 = {
  ...
  colors: ['var(--secondary)', 'var(--success)', 'var(--warning)', 'var(--primary)'],
  responsive: [
    {
      breakpoint: 576,
      options: {
