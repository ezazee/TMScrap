      ...
      item: [
        {
          title: `
            <div class="kanban-box">
                  <div class="kanab-item-1 p-5 2xl:p-4 border border-light bg-white dark:bg-mode-300 rounded-5 flex flex-col gap-5 2xl:gap-3">
                        <div class="flex items-center gap-2">
                        <div class="min-w-3 w-3 min-h-3 h-3 rounded-full bg-primary"></div>
                        <h5 class="w-[calc(100%_-_12px)] 2xl:text-xs text-sm text-dark">Final Test For The Design Issues </h5>
                        </div>
      ...
      item: [
        {
          title: `
            <div class="kanban-box">
                  <div class="kanab-item-1 p-5 2xl:p-4 border-l-4 border-l-success border border-light bg-white dark:bg-mode-300 rounded-5 flex flex-col gap-5 2xl:gap-3">
                        <div class="flex items-center gap-2">
        ...
        },
        {
          title: ` 
          <div class="kanban-box">
                  <div class="kanab-item-1 p-5 2xl:p-4 border-l-4 border-l-warning  border border-light bg-white dark:bg-mode-300 rounded-5 flex flex-col gap-5 2xl:gap-3">
                        <div class="flex items-center gap-2">
        ...
        },
        {
          title: ` 
          <div class="kanban-box">
                  <div class="kanab-item-1 p-5 2xl:p-4 border-l-4 border-l-danger  border border-light bg-white dark:bg-mode-300 rounded-5 flex flex-col gap-5 2xl:gap-3">
                        <div class="flex items-center gap-2">
      ...
      item: [
        {
          title: `
               <div class="kanban-box">
                  <div class="kanab-item-1 p-5 2xl:p-4 border-l-4 border-l-info border border-light bg-white dark:bg-mode-300 rounded-5 flex flex-col gap-5 2xl:gap-3">
